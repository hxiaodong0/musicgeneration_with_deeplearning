...
class GAN():
    ...
    def build_generator(self):
        ...
        model = Sequential()
        model.add(Embedding(self.seq_shape[1], self.latent_dim, input_lengh=self.seq_shape[0]))
    ...
    def train(self, epochs, train_data, batch_size=128, sample_interval=50):
        ...
        track = pypianoroll.Track(pianoroll=predictions, program=0, is_drum=False,
                      name='my awesome piano')
        pypianoroll.write(track, "C:\\Users\\10413\\Desktop\\deep_learning\\project\\midi-lstm-gan-master\\output")
